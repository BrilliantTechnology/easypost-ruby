...
Gem::Specification.new do |spec|
  spec.name = 'easypost_v5'
  spec.version = EasyPostV5::VERSION
  spec.license = 'MIT'
  spec.summary = 'EasyPostV5 Ruby Client Library'
  spec.description = 'Client library for accessing the EasyPostV5 shipping API via Ruby.'
  spec.authors = 'EasyPostV5 Developers'
