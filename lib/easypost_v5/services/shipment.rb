...
class EasyPostV5::Services::Shipment < EasyPostV5::Services::Service
  MODEL_CLASS = EasyPostV5::Models::Shipment
  ...
  def lowest_smart_rate(id, delivery_days, delivery_accuracy)
    ...
    EasyPostV5::Util.get_lowest_smart_rate(smart_rates, delivery_days, delivery_accuracy)
  end
