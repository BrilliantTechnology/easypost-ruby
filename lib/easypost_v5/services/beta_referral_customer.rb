...
class EasyPostV5::Services::BetaReferralCustomer < EasyPostV5::Services::Service
  ...
  def add_payment_method(stripe_customer_id, payment_method_reference, priority = 'primary')
    ...
    @client.make_request(
      ...
      EasyPostV5::Models::EasyPostObject,
      wrapped_params,
      'beta',
    )
  end
  ...
  def refund_by_amount(amount)
    ...
    @client.make_request(:post, 'referral_customers/refunds', EasyPostV5::Models::EasyPostObject, params, 'beta')
