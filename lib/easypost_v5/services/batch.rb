...
class EasyPostV5::Services::Batch < EasyPostV5::Services::Service
  MODEL_CLASS = EasyPostV5::Models::Batch
  ...
  def all(params = {})
    @client.make_request(:get, 'batches', EasyPostV5::Models::ApiKey, params)
  end
