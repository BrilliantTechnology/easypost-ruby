...
describe EasyPostV5::Errors do
  ...
  describe 'api error' do
    ...
    it 'deserialize HTTP error response properly' do
      ...
      expect(first_error).to be_a(EasyPostV5::Models::Error)
