...
describe EasyPostV5::Services::CustomsItem do
  ...
  describe '.create' do
    it 'creates a customs item' do
      ...
      expect(customs_item).to be_an_instance_of(EasyPostV5::Models::CustomsItem)
  ...
  describe '.retrieve' do
    it 'retrieves a customs item' do
      ...
      expect(retrieved_customs_item).to be_an_instance_of(EasyPostV5::Models::CustomsItem)
