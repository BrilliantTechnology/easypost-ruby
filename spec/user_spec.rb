...
describe EasyPostV5::Services::User, :authenticate_prod do
  ...
  describe '.create' do
    it 'creates a child user' do
      ...
      expect(user).to be_an_instance_of(EasyPostV5::Models::User)
  ...
  describe '.update' do
    it 'updates a user' do
      ...
      expect(updated_user).to be_an_instance_of(EasyPostV5::Models::User)
  ...
  describe '.all_api_keys' do
    it 'retrieves all API keys' do
      ...
      expect(api_keys.keys).to all(be_an_instance_of(EasyPostV5::Models::ApiKey))
      api_keys.children.each do |child|
        expect(child.keys).to all(be_an_instance_of(EasyPostV5::Models::ApiKey))
      end
    end
  end
  ...
  describe '.api_keys' do
    it "retrieves the authenticated user's API keys" do
      ...
      expect(api_keys).to all(be_an_instance_of(EasyPostV5::Models::ApiKey))
    end
  ...
  describe '.update_brand' do
    it "updates the authenticated user's brand" do
      ...
      expect(brand).to be_an_instance_of(EasyPostV5::Models::Brand)
